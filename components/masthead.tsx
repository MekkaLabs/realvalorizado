...
const Masthead: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <div className={`flex-grow-0 pt-10 transition-opacity duration-1000 ${imageLoaded ? 'opacity-0' : 'opacity-100'}`}>
                <Image
                    src="/assets/logo.svg"
                    width={128 / 3}
                    height={114 / 3}
            ...
            <div className={`flex-grow-0 pb-20 md:pb-10 transition-all duration-1000 ${imageLoaded ? 'opacity-0' : 'opacity-100  -translate-y-10'}`}>
                <Image
